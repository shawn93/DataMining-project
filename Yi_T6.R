library(tree)
set.seed(1)
data = read.csv("/Users/Yi/Desktop/DMP/Tree/6.csv")
dim(data)
# [1] 10000    31
...
# Residual mean deviance:  0.7661 = 2680 / 3498 
# Misclassification error rate: 0.1323 = 463 / 3500 
# > 
tree_predict1 = predict(tree_model1, testing)
summary(tree_predict1)
# f                t          
# Min.   :0.8371   Min.   :0.07741  
# 1st Qu.:0.8371   1st Qu.:0.07741  
# Median :0.8371   Median :0.16288  
# Mean   :0.8654   Mean   :0.13456  
# 3rd Qu.:0.9226   3rd Qu.:0.16288  
# Max.   :0.9226   Max.   :0.16288 
## Cross Validation
...
# Variables actually used in tree construction:
#   [1] "donation_optional_support"
# Number of terminal nodes:  2 
# Residual mean deviance:  0.7618 = 2665 / 3498 
# Misclassification error rate: 0.1323 = 463 / 3500 
